...
import gui.TransaksiPelanggan;
import static gui.TransaksiPelanggan.txNofak;
 ...
 * @author Acer
 */
public class control_transaksiPelanggan extends koneksi{
    public control_transaksiPelanggan(){
        setKoneksi();
    }
