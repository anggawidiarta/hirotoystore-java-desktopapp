 ...
 * @author ASUS
 */
public class frmCariBarangPelanggan extends javax.swing.JDialog {
    masterBarang mb;
    pelanggan pl;
    String caller ="";
    /**
     ...
     */
    public frmCariBarangPelanggan(java.awt.Frame parent, boolean modal,String caller) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(caller.equalsIgnoreCase("Transaksi")){
            ...
            TransaksiPelanggan.txkode.setText(kode);
            TransaksiPelanggan.txnama.setText(nama);
            TransaksiPelanggan.harga = harga;
            TransaksiPelanggan.stok = stok;
            TransaksiPelanggan.txqty.setEditable(true);
            TransaksiPelanggan.btnSimpan.setEnabled(true);
            TransaksiPelanggan.txqty.requestFocus();
            dispose();
        }else if(caller.equalsIgnoreCase("Pelanggan")){
            int row = tabel.getSelectedRow();
            String id = tabel.getValueAt(row, 0).toString();
            String nama = tabel.getValueAt(row, 1).toString();
            TransaksiPelanggan.txidPelanggan.setText(id);
            TransaksiPelanggan.txpelanggan.setText(nama);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmCariBarangPelanggan dialog = new frmCariBarangPelanggan(new javax.swing.JFrame(), true,"");
